...
```bash
git clone https://github.com/Rishika-28/assignment-8-Rishika-28.git
cd assignment-8-Rishika-28
```
2. Open assignment8 in Jupyter Notebook.

3. Run all cells in sequence. 

## Notes
1. The downloading of the dataset is given within the code.
